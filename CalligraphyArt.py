...
#        print event.y
        ...
        self.draw_wnd.move_canvas(self.pos)
    ...
    def bg_com(self):
        ...
        self.bg_color=tkcolorpicker.askcolor((255, 255, 0), self.wnd)
    ...
    def fg_com(self):
        ...
        self.fg_color =tkcolorpicker.askcolor((255, 255, 0), self.wnd)
    ...
    def draw(self):
        ...
        letters_dict = ["a","b","t","th","j","h","kh","d","dh","r","z","s","sh","S","D","T","DH","3","gh","f","q","k","l","m","n","H","w"]
